...
class TestAPIIntegration:
    ...
    def test_query_endpoint_basic(self, client):
        ...
        with patch.object(rag_system, 'query') as mock_query:
            ...
            with patch.object(rag_system.session_manager, 'create_session') as mock_create:
    ...
    def test_end_to_end_content_query(self, mock_anthropic_class, client):
        ...
        mock_final_response.content[0].text = "Computer use enables automated interactions with digital interfaces."
    ...
    def test_end_to_end_outline_query(self, mock_anthropic_class, client):
        ...
        mock_final_response = MagicMock()
        mock_final_response.content = [MagicMock()]
        mock_final_response.content[0].text = "The MCP course covers lesson 1, lesson 2, and lesson 3."
